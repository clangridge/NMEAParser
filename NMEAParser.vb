        ...
        Try
            ...
            If sentenceArray(0).Contains("GGA") Then
                ...
                If HAVE_POSITION Then
                    ...
                    NEW_LOCATION(True)
                    _timeoutTimer.Start()
                    '    MyBase.UpdateLocation(NEW_LOCATION(True))

                End If

                'ElseIf sentenceArray(0).Contains("GSA") Then
                '    Dim fixValue As Integer = Convert.ToInt32(sentenceArray(2))
                '    If fixValue > 1 Then
                '        Dim index As Integer = sentenceArray.Length - 3
                '        SET_HDOP = sentenceArray(index)
...
#Region "Properties"
    ...
    '''' <summary>
    '''' Gets the current heading for the GPS unit
    '''' </summary>
    '''' <returns></returns>
    ...
    'Public WriteOnly Property FORM_CLOSING As Boolean
